/*
SPDX-FileCopyrightText: 2026 SAP SE or an SAP affiliate company and secret-generator-cop contributors
...
const Name = "secret-generator-cop.cs.sap.com"
...
func (o *Operator) Setup(mgr ctrl.Manager) error {
	...
	if err := component.NewReconciler[*operatorv1alpha1.SecretGenerator](
		o.options.Name,
		resourceGenerator,
